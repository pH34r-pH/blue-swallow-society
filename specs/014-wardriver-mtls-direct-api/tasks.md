...
- [ ] T3. **Partially complete:** declare Key Vault ownership, the `:8443` Caddy listener, public trust-bundle injection, NSG ingress, and CI parameters. Live deployment is blocked until protected CI inputs are configured; no PFX/private key is accepted.
