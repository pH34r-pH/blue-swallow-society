...
2. Add a Key Vault Bicep resource that matches the provisioned vault: RBAC authorization, purge protection, 90-day soft-delete retention, and no secret-valued outputs. The deployment workflow obtains only the approved public PEM trust bundle for Caddy through OIDC.
