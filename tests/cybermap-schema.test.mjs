...
test('VM Cybermap installer applies checked-in SQL migrations with psql', () => {
  ...
  assert.match(installCybermapApi, /DATABASE_URL=postgresql:\/\/__POSTGRES_ADMINISTRATOR_LOGIN__:\$\{POSTGRES_PASSWORD_URLENCODED\}@__POSTGRES_SERVER_FQDN__:5432\/__POSTGRES_DATABASE_NAME__\?sslmode=require/);
