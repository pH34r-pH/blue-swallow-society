...
test('VM Bicep provisions Cybermap API gateway services instead of public echo ingress', () => {
  ...
  assertIncludesAll(vmBicep, [
    ...
    '/opt/cybermap-api/observation-ingest.mjs',
    '/opt/cybermap-api/sensorium.mjs',
    '/opt/cybermap-api/claim-validation.mjs',
    ...
    '/opt/cybermap-worker/greenfeeds/catalog.mjs',
    '/opt/cybermap-worker/greenfeeds/poller.mjs',
