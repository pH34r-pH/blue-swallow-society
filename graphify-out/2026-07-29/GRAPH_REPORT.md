# Graph Report - blue-swallow-memory-scope  (2026-07-29)

## Corpus Check
- 349 files · ~317,496 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5911 nodes · 12478 edges · 325 communities (246 shown, 79 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 653 edges (avg confidence: 0.65)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `cb3c16b0`
...
Cohesion: 0.06
Nodes (33): API Endpoints, Authentication & Authorization, Azure Function Implementation (`api/echo/index.js`), Azure Functions Proxy Layer, cloud-init Provisioning, Configuration Points, Current Limitations, Current State (+25 more)
...
Cohesion: 0.13
Nodes (40): abortIfPresent(), abortInFlight(), bindTzeentchSurfaceTabs(), buildOperatorHeaders(), classifyEvidenceTags(), createEmptyState(), createEmptyTzeentchPayload(), formatPaperQuantity() (+32 more)
...
Cohesion: 0.01
Nodes (121): addBucket(), addDash(), addRegularDash(), addRoundDash(), af, ai(), bo, broadcast() (+113 more)
...
Cohesion: 0.08
Nodes (26): aggregateCaveats(), aggregateFreshness(), boundedGlobalLimit(), briefSummary(), cellUsesOnlyEligibleLayers(), centroidInBbox(), cloneBrief(), compareAggregateCells() (+18 more)
...
Cohesion: 0.07
Nodes (70): createGodeyeController(), activateTab(), activateTabByIndex(), applyVisionDataset(), bindMorningBriefReturn(), bindOperatorDownloads(), bindTabSystem(), bindVisionControls() (+62 more)
...
Cohesion: 0.08
Nodes (23): bleBatch(), credential(), hashToken(), IngestError, tokenDigestMatches(), ContractError, NOW, request (+15 more)

### Community 29 - "server.mjs"
Cohesion: 0.07
Nodes (57): boundedDiagnosticCode(), buildEchoPayload(), clampFiniteNumber(), createRequestHandler(), forbiddenWithDiagnostic(), GLOBAL_VIEWPORT_LAYER_IDS, handleCybermapTile(), handleCybermapViewportPost() (+49 more)
...
Cohesion: 0.01
Nodes (103): ab(), addImageSection(), addTextSection(), angleWith(), angleWithSep(), ap, bb(), Bh (+95 more)

### Community 37 - "operator-auth.js"
Cohesion: 0.13
Nodes (20): base64UrlDecode(), buildClearOperatorSessionCookie(), buildOperatorSessionCookie(), crypto, extractCookieValue(), extractOperatorTokens(), getConfiguredDigest(), getOperatorId() (+12 more)
...
Cohesion: 0.03
Nodes (102): _addDefaultHandlers(), addTo(), _blockedByActive(), bp, _cancelRenderFrame(), Cc(), _clearWatch(), cloneImages() (+94 more)
...
Cohesion: 0.04
Nodes (82): addTileFeatures(), ah(), Am(), appendLeaves(), bm(), ch(), cluster(), _convertIndices() (+74 more)
...
Cohesion: 0.09
Nodes (34): allowVariableZoom(), calculateCameraOptionsFromTo(), calculateCenterFromCameraLngLatAlt(), _calculateNearFarZIfNeeded(), _distanceToCenterFromAltElevationPitch(), ea(), _elevateCameraIfInsideTerrain(), extend() (+26 more)
...
Cohesion: 0.19
Nodes (17): BBOX_FIELDS, buildDeflockViewportResponse(), CELL_FIELDS, CENTROID_FIELDS, DeflockViewportError, finite(), LAYER_IDS, rejectUnknown() (+9 more)
...
Cohesion: 0.08
Nodes (35): fov(), ao(), Bi(), bo(), checkSubtype(), co(), compare(), Do() (+27 more)
...
Cohesion: 0.05
Nodes (48): aa(), _addTile(), allowWorldCopies(), _areDescendentsComplete(), getAllIds(), getCoveringTilesDetailsProvider(), getIds(), _getLoadedDescendents() (+40 more)
...
Cohesion: 0.17
Nodes (13): boundedNumber(), createGlobalViewportClient(), createGodeyeGlobalRenderer(), DEFAULT_GODEYE_GLOBAL_VIEWPORT, deriveState(), healthStates(), normalizeGlobalViewportResponse(), renderCellEntry() (+5 more)
...
Cohesion: 0.04
Nodes (76): addControl(), addImage(), addLayer(), addSource(), addSprite(), _applyGlobalStateChanges(), _applyResourceTiming(), ba() (+68 more)
...
Cohesion: 0.13
Nodes (11): dbReadme, globalSourceMigration, globalSourceMigrationLower, ingestMigration, ingestMigrationLower, installCybermapApi, migration, migrationLower (+3 more)
...
Cohesion: 0.10
Nodes (33): _calculateTransform(), contextmenu(), _destroyUI(), disable(), dragEnd(), dragMove(), dragStart(), enable() (+25 more)
...
Cohesion: 0.07
Nodes (39): $a(), add(), addClassName(), ao(), Ca(), co(), fo(), getPerspectiveRatio() (+31 more)
...
Cohesion: 0.12
Nodes (38): activateGodeyeMode(), applyWigleDataset(), bindDeflockGlobalControls(), bindGodeyeControls(), bindGodeyeModeControls(), buildDeflockGlobalRequest(), getCurrentPosition(), handleGeoError() (+30 more)

### Community 84 - "mosaic_murmurs_market_data.py"
Cohesion: 0.07
Nodes (47): id(), ac(), addCurrentVertex(), addHalfVertex(), addLine(), addToLineVertexArray(), addToSortKeyRanges(), angleTo() (+39 more)
...
### Community 95 - "add"
Cohesion: 0.06
Nodes (42): _addTerrainIdealTiles(), _cleanUpRasterTiles(), _clearSource(), _clearTileReloadTimer(), clearTiles(), _dataHandler(), destruct(), equals() (+34 more)
...
Cohesion: 0.05
Nodes (52): _afterImageUpdated(), _afterTileLoadWorkerResponse(), _charUsesLocalIdeographFontFamily(), clearTextures(), _createTinySDF(), destroy(), _diffStyle(), dispatchRenderCallbacks() (+44 more)

### Community 98 - "Requirements"
Cohesion: 0.08
Nodes (37): bbox(), Dm(), Em(), jg(), kg(), loadGeometry(), nextField(), Ng() (+29 more)
...
Cohesion: 0.03
Nodes (104): add(), addIndicesForPlacedSymbol(), as(), ax(), ay(), Bx(), by(), clear() (+96 more)
...
Cohesion: 0.10
Nodes (26): _getOperationsToPerform(), Li(), qc(), serialize(), _serializeByIds(), _serializedAllLayers(), setState(), Cl() (+18 more)
...
### Community 119 - "clamp"
Cohesion: 0.05
Nodes (62): av(), bg(), calculateScaledKey(), determineAverageLineWidth(), determineLineBreaks(), Dv(), ev(), feature() (+54 more)
...
Cohesion: 0.09
Nodes (25): Ad(), ag(), Cd(), _convertFromCellCoord(), _convertToCellCoord(), Ed(), expandBy(), _forEachCell() (+17 more)
...
Cohesion: 0.12
Nodes (8): hashCanonicalJson(), hashPersistedObservation(), isContentHash(), unscopedObservationIdentity(), check(), credentialRow, FakePool, ScriptedClient

### Community 136 - "index.js"
Cohesion: 0.15
Nodes (29): activeObjectUrls, api(), appendArtifactControls(), appendMetadata(), artifactFilename(), artifactHref(), detailNode, dossierPages() (+21 more)
...
### Community 138 - "postgres-store.test.mjs"
Cohesion: 0.06
Nodes (44): addFeature(), addFeatures(), addLineDashDependencies(), bc, _calculate(), calculateGlyphDependencies(), cm(), constantOr() (+36 more)
...
Cohesion: 0.15
Nodes (25): _afterEase(), dblclick(), _ease(), easeTo(), _finalizeElevation(), _fireMoveEvents(), _fitInternal(), flyTo() (+17 more)

### Community 141 - "passcode-api.test.mjs"
Cohesion: 0.04
Nodes (56): acquireRTT(), anyTilesAfterTime(), attemptAnchorPlacement(), bindRTT(), _cleanUpVectorTiles(), clearSymbolFadeHold(), commit(), continuePlacement() (+48 more)
...
### Community 145 - "applyVisionDataset"
Cohesion: 0.12
Nodes (58): ac(), contains(), _flattenAndSortRenderedFeatures(), Ga(), gs(), handleEaseTo(), handleFlyTo(), handleMapControlsRollPitchBearingZoom() (+50 more)
...
Cohesion: 0.12
Nodes (29): cameraPosition(), _computeTileBoundingVolume(), Cs(), ec(), fromAabb(), fromCenterSizeAngles(), fromInvProjectionMatrix(), Js() (+21 more)

### Community 150 - "Recommended delivery sequence"
Cohesion: 0.06
Nodes (41): addImages(), af(), backfillBorder(), completeTask(), constructor(), copy(), crossFadingFactor(), dd() (+33 more)
...
### Community 153 - "paper-state-proxy.test.mjs"
Cohesion: 0.12
Nodes (23): calculatePosMatrix(), da(), di(), getAllTiles(), getFastPathSimpleProjectionMatrix(), getProjectionDataForCustomLayer(), getTerrainCoords(), _getTerrainCoordsForRegularTile() (+15 more)
...
### Community 157 - "ud"
Cohesion: 0.05
Nodes (115): ad(), al(), bd(), bind(), _bindFramebuffer(), bl(), Bs(), Bu() (+107 more)

### Community 158 - "Recommended delivery sequence"
Cohesion: 0.08
Nodes (42): aa(), ba(), ca(), canonicalID(), da(), distance(), _down(), Ea() (+34 more)
...
Cohesion: 0.08
Nodes (39): gestureBeginsVertically(), bf(), bp(), _colorRampChanged(), _createColorRamp(), dp(), ep(), ff() (+31 more)
...
Cohesion: 0.06
Nodes (52): readImageNow(), an(), H(), hn(), ji(), ln, nl, rn() (+44 more)
...
### Community 174 - "clear"
Cohesion: 0.09
Nodes (16): pool, port, server, store, createCybermapApiServer(), GlobalViewportStore, postGlobalViewport(), VALID_REQUEST (+8 more)
...
### Community 177 - "Audit boundaries and provenance"
Cohesion: 0.26
...
Cohesion: 0.10
Nodes (21): _applyChanges(), createFramebuffer(), createRenderbuffer(), depthAtPoint(), getDEMElevation(), getElevation(), getElevationForLngLatZoom(), getFramebuffer() (+13 more)

### Community 192 - "error"
Cohesion: 0.21
Nodes (12): addSymbols(), emplace(), getPositionIds(), getPositions(), populatePaintArray(), populatePaintArrays(), _setPaintValue(), _setPaintValues() (+4 more)
...
Cohesion: 0.09
Nodes (41): apply(), applyUpdatedTransform(), _calcMatrices(), cameraForBoxAndBearing(), _clearMatrixCaches(), clearNearFarZOverride(), clone(), _computeClippingPlane() (+33 more)
...
### Community 214 - "Wu"
Cohesion: 0.10
Nodes (20): base64UrlEncode(), createOperatorToken(), { createOperatorToken }, invokeRoute(), makeOperatorHeaders(), require, restoreEnv(), TEST_OPERATOR_DIGEST (+12 more)
...
Cohesion: 0.12
Nodes (21): getCartesianPosition(), getRayDirectionFromPixel(), ho(), isLocationOccluded(), isSurfacePointOnScreen(), isSurfacePointVisible(), lngLatToCameraDepth(), _projectSurfacePointToScreen() (+13 more)
...
### Community 278 - "global-viewport-contract.test.mjs"
Cohesion: 0.25
...
### Community 291 - "Reliability Features"
Cohesion: 0.50
...
Cohesion: 0.07
Nodes (30): forbidden(), aggregateCaveats(), aggregateFreshness(), aggregateLayers(), aggregateSourceClasses(), boundedGlobalLimit(), finiteInteger(), finiteOrNull() (+22 more)
...
### Community 323 - "vm-api.md"
Cohesion: 0.15
Nodes (10): Former topology, Historical VM echo wiring (retired), BSS Cybermap API — authenticated observation ingest, Device enrollment record, Implemented, Not yet implemented or promoted, Request contract, Response semantics (+2 more)

### Community 324 - "_executeRelevantHandler"
Cohesion: 0.31
...
## Knowledge Gaps
- **1481 isolated node(s):** `check-prerequisites.sh script`, `common.sh script`, `create-new-feature.sh script`, `setup-plan.sh script`, `setup-tasks.sh script` (+1476 more)
...
- **Why does `error()` connect `main.js` to `index.js`, `postgres-store.test.mjs`, `hashCanonicalJson`, `index.js`, `greenfeed-worker.mjs`, `Implementation Plan: Static Web Application Functionality`, `index.js`, `clear`, `server.mjs`, `morning-brief-api.test.mjs`, `$`, `main.js`, `Recommended delivery sequence`, `adapter-contract.mjs`, `morning-brief.test.mjs`, `validatePaperState`?**
  _High betweenness centrality (0.095) - this node is a cross-community bridge._
- **Why does `key()` connect `tzeentch.mjs` to `index.js`, `postgres-store.test.mjs`, `operator-auth.js`, `deflock-viewport-contract.mjs`, `tzeentch-dashboard.mjs`, `_executeRelevantHandler`, `wigle.mjs`, `clear`, `createIndexBuffer`, `cybermap-global-viewport-api.test.mjs`, `$`, `cybermap-viewport-api.test.mjs`, `Wu`, `contracts.mjs`, `validatePaperState`, `vision.mjs`, `server.mjs`?**
  _High betweenness centrality (0.054) - this node is a cross-community bridge._
- **Why does `record()` connect `passcode-api.test.mjs` to `tzeentch.mjs`, `wigle.mjs`, `morning-brief.mjs`, `global-viewport-contract.mjs`, `vision.mjs`, `server.mjs`?**
