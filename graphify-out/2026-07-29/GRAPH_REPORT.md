# Graph Report - blue-swallow-best-effort-reconciliation  (2026-07-29)

## Corpus Check
- 355 files · ~321,293 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5946 nodes · 12531 edges · 334 communities (250 shown, 84 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 654 edges (avg confidence: 0.65)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2fbf24e3`
...
## Communities (334 total, 84 thin omitted)
...
Cohesion: 0.25
Nodes (19): createEmptyState(), initTzeentchDashboard(), loadOverview(), persistRecentQueries(), rememberRecentQuery(), renderFailure(), renderPayload(), renderRecentQueries() (+11 more)
...
Cohesion: 0.01
Nodes (156): aa(), acquire(), addBucket(), addDash(), addRegularDash(), addRoundDash(), af, _applyDiffToSource() (+148 more)
...
Cohesion: 0.07
Nodes (28): aggregateCaveats(), aggregateFreshness(), boundedGlobalLimit(), briefSummary(), cellUsesOnlyEligibleLayers(), centroidInBbox(), cloneBrief(), compareAggregateCells() (+20 more)
...
Cohesion: 0.12
Nodes (40): activateGodeyeMode(), applyWigleDataset(), bindDeflockGlobalControls(), bindGodeyeControls(), bindGodeyeModeControls(), buildDeflockGlobalRequest(), emptyWigleDataset(), getCurrentPosition() (+32 more)

### Community 17 - "main.js"
Cohesion: 0.07
Nodes (70): createGodeyeController(), createGodeyeGlobalRenderer(), activateTab(), activateTabByIndex(), applyVisionDataset(), bindMorningBriefReturn(), bindOperatorDownloads(), bindTabSystem() (+62 more)
...
Cohesion: 0.10
Nodes (21): bleBatch(), credential(), hashToken(), tokenDigestMatches(), NOW, ingestHeaders(), validBatch(), validObservation() (+13 more)

### Community 29 - "server.mjs"
Cohesion: 0.07
Nodes (55): boundedDiagnosticCode(), buildEchoPayload(), clampFiniteNumber(), createRequestHandler(), forbiddenWithDiagnostic(), GLOBAL_VIEWPORT_LAYER_IDS, handleCybermapTile(), handleCybermapViewportPost() (+47 more)
...
Cohesion: 0.01
Nodes (127): ab(), addImageSection(), addTextSection(), angleWith(), angleWithSep(), ap, av(), ay() (+119 more)
...
Cohesion: 0.03
Nodes (115): add(), addClassName(), _addDefaultHandlers(), addTo(), _applyChanges(), _blockedByActive(), bp, _cancelRenderFrame() (+107 more)
...
Cohesion: 0.04
Nodes (92): addIndicesForPlacedSymbol(), addTileFeatures(), ah(), Am(), appendLeaves(), bm(), ch(), clear() (+84 more)
...
Cohesion: 0.11
Nodes (25): al(), calculatePosMatrix(), da(), di(), getAllTiles(), getFastPathSimpleProjectionMatrix(), getProjectionDataForCustomLayer(), getState() (+17 more)
...
Cohesion: 0.08
Nodes (36): bbox(), Dm(), Em(), jg(), kg(), loadGeometry(), nextField(), Ng() (+28 more)
...
Cohesion: 0.02
Nodes (138): addControl(), addImage(), addLayer(), addSource(), addSprite(), _afterImageUpdated(), _afterTileLoadWorkerResponse(), _applyGlobalStateChanges() (+130 more)
...
Cohesion: 0.06
Nodes (49): _calculateTransform(), contextmenu(), convert(), dblclick(), dragEnd(), dragMove(), dragStart(), _f() (+41 more)
...
Cohesion: 0.10
Nodes (31): $a(), co(), fo(), getPerspectiveRatio(), go(), ho(), io(), isInsideGrid() (+23 more)
...
Cohesion: 0.09
Nodes (34): addFeature(), addFeatures(), addLineDashDependencies(), ai(), bc, _calculate(), calculateGlyphDependencies(), containsPolygonGeometry() (+26 more)

### Community 84 - "mosaic_murmurs_market_data.py"
Cohesion: 0.11
Nodes (24): addCurrentVertex(), addHalfVertex(), addLine(), addToLineVertexArray(), addToSortKeyRanges(), angleTo(), clone(), di (+16 more)
...
### Community 95 - "add"
Cohesion: 0.03
Nodes (106): _addTerrainIdealTiles(), _addTile(), anyTilesAfterTime(), _areDescendentsComplete(), attemptAnchorPlacement(), _cleanUpRasterTiles(), _cleanUpVectorTiles(), _clearSource() (+98 more)
...
Cohesion: 0.08
Nodes (26): containsMaxSafeIntegerValues(), dc(), deserialize(), extend(), fc(), freeBufferAfterUpload(), fromPoints(), getFeatures() (+18 more)
...
Cohesion: 0.04
Nodes (91): ac(), add(), as(), ax(), bs(), Bx(), concat(), cs() (+83 more)
...
Cohesion: 0.09
Nodes (42): abortIfPresent(), abortInFlight(), bindTzeentchSurfaceTabs(), buildOperatorHeaders(), classifyEvidenceTags(), createEmptyTzeentchPayload(), formatPaperQuantity(), formatPaperUsd() (+34 more)
...
### Community 119 - "clamp"
Cohesion: 0.05
Nodes (58): bg(), calculateScaledKey(), determineAverageLineWidth(), determineLineBreaks(), Dv(), ev(), feature(), getSection() (+50 more)
...
Cohesion: 0.05
Nodes (52): id(), Ad(), ag(), at(), Cd(), convert(), _convertFromCellCoord(), _convertToCellCoord() (+44 more)
...
Cohesion: 0.08
Nodes (44): cameraPosition(), _computeTileBoundingVolume(), Cs(), ec(), fromAabb(), fromCenterSizeAngles(), fromInvProjectionMatrix(), getCameraFrustum() (+36 more)

### Community 150 - "Recommended delivery sequence"
Cohesion: 0.05
Nodes (44): addImages(), af(), backfillBorder(), bind(), cn, completeTask(), constantOr(), constructor() (+36 more)
...
### Community 157 - "ud"
Cohesion: 0.05
Nodes (122): ad(), bd(), bind(), bl(), Bs(), Bu(), _buildSkirts(), $c() (+114 more)

### Community 158 - "Recommended delivery sequence"
Cohesion: 0.07
Nodes (50): aa(), ao(), ba(), bt(), ca(), canonicalID(), da(), dd() (+42 more)
...
Cohesion: 0.07
Nodes (42): bf(), bp(), _colorRampChanged(), _createColorRamp(), dp(), ep(), ff(), fp() (+34 more)
...
Cohesion: 0.07
Nodes (48): an(), H(), hn(), ji(), nl, tn(), zn(), abort() (+40 more)
...
### Community 174 - "clear"
Cohesion: 0.07
Nodes (16): IngestError, pool, port, server, store, createCybermapApiServer(), request, GlobalViewportStore (+8 more)
...
Cohesion: 0.10
Nodes (5): forbidden(), PostgresObservationStore, REQUIRED_MIGRATIONS, rowToMorningBriefSummary(), Pool
...
Cohesion: 0.04
Nodes (140): ac(), acquireRTT(), _afterEase(), ao(), apply(), applyUpdatedTransform(), bindRTT(), _calcMatrices() (+132 more)
...
Cohesion: 0.08
Nodes (31): ai(), allowVariableZoom(), allowWorldCopies(), extend(), fa(), getCameraPoint(), getCameraQueryGeometry(), getClippingPlane() (+23 more)
...
Cohesion: 0.11
Nodes (30): deriveWardriverProgress(), hashCanonicalJson(), hashPersistedObservation(), aggregateCaveats(), aggregateFreshness(), aggregateLayers(), aggregateSourceClasses(), boundedGlobalLimit() (+22 more)

### Community 295 - "Reliability Features"
Cohesion: 0.50
...
### Community 305 - "Service Architecture"
Cohesion: 0.67
...
### Community 330 - "clone"
Cohesion: 0.20
Nodes (12): _charUsesLocalIdeographFontFamily(), _downloadAndCacheRangePromise(), _drawGlyph(), _getAndCacheGlyphsPromise(), getGlyphs(), getImages(), _getImagesForIds(), isLoaded() (+4 more)

## Knowledge Gaps
- **1501 isolated node(s):** `check-prerequisites.sh script`, `common.sh script`, `create-new-feature.sh script`, `setup-plan.sh script`, `setup-tasks.sh script` (+1496 more)
...
- **Why does `error()` connect `main.js` to `index.js`, `postgres-store.test.mjs`, `hashCanonicalJson`, `index.js`, `greenfeed-worker.mjs`, `Implementation Plan: Static Web Application Functionality`, `index.js`, `postgres-store.mjs`, `Mosaic & Murmurs Autonomous Paper Engine`, `server.mjs`, `clear`, `$`, `main.js`, `Recommended delivery sequence`, `adapter-contract.mjs`, `validatePaperState`?**
  _High betweenness centrality (0.088) - this node is a cross-community bridge._
- **Why does `key()` connect `tzeentch.mjs` to `index.js`, `tzeentch-dashboard.mjs`, `wigle.mjs`, `createIndexBuffer`, `$`, `_executeRelevantHandler`, `vision.mjs`, `server.mjs`, `postgres-store.test.mjs`, `operator-auth.js`, `hashCanonicalJson`, `contracts.mjs`, `Integration Points`, `validatePaperState`, `deflock-viewport-contract.mjs`, `Wu`, `index.js`, `cybermap-global-viewport-api.test.mjs`, `cybermap-viewport-api.test.mjs`?**
  _High betweenness centrality (0.058) - this node is a cross-community bridge._
- **Why does `createRequestHandler()` connect `server.mjs` to `wardriver-release-store.js`, `clear`, `main.js`, `Recommended delivery sequence`, `add`?**
