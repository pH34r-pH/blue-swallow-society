...
## Corpus Check
- 313 files · ~300,189 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5634 nodes · 12018 edges · 312 communities (241 shown, 71 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 631 edges (avg confidence: 0.65)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `771cd3e4`
...
Cohesion: 0.09
Nodes (45): abortIfPresent(), abortInFlight(), bindTzeentchSurfaceTabs(), buildOperatorHeaders(), classifyEvidenceTags(), createEmptyTzeentchPayload(), formatPaperQuantity(), formatPaperUsd() (+37 more)
...
Cohesion: 0.01
Nodes (127): addBucket(), addDash(), addRegularDash(), addRoundDash(), adjustAntiMeridian(), bo, broadcast(), calculateFogBlendOpacity() (+119 more)
...
Cohesion: 0.18
Nodes (21): aggregateCaveats(), aggregateFreshness(), aggregateLayers(), aggregateSourceClasses(), boundedGlobalLimit(), finiteInteger(), finiteOrNull(), GLOBAL_SOURCE_CLASSES (+13 more)

### Community 17 - "main.js"
Cohesion: 0.10
Nodes (39): applyWigleDataset(), bindLoginFlow(), bindMorningBriefReturn(), bindOperatorDownloads(), buildOperatorHeaders(), compactFingerprint(), DEFLOCK_GLOBAL_BBOX, DEFLOCK_GLOBAL_CENTER (+31 more)
...
### Community 20 - "$"
Cohesion: 0.14
Nodes (30): activateGodeyeMode(), bindDeflockGlobalControls(), bindGodeyeControls(), bindGodeyeModeControls(), buildDeflockGlobalRequest(), clearOperatorSession(), getCurrentPosition(), handleGeoError() (+22 more)
...
Cohesion: 0.07
Nodes (21): hashToken(), IngestError, tokenDigestMatches(), NOW, ingestHeaders(), validBatch(), validObservation(), canonicalPaperState() (+13 more)

### Community 29 - "server.mjs"
Cohesion: 0.08
Nodes (52): buildEchoPayload(), canonicalJson(), clampFiniteNumber(), createRequestHandler(), GLOBAL_VIEWPORT_LAYER_IDS, handleCybermapTile(), handleCybermapViewport(), handleMorningBriefRequest() (+44 more)
...
Cohesion: 0.01
Nodes (121): ab(), addImageSection(), addTextSection(), angleWith(), angleWithSep(), ap, ay(), bb() (+113 more)

### Community 37 - "operator-auth.js"
Cohesion: 0.16
Nodes (21): base64UrlDecode(), base64UrlEncode(), buildClearOperatorSessionCookie(), buildClearOperatorSessionCookieOptions(), buildOperatorSessionCookie(), createOperatorAssetGrant(), crypto, extractCookieValue() (+13 more)

### Community 38 - "Tasks: Static Web Application Functionality"
Cohesion: 0.17
Nodes (24): disableArFeed(), emptyWigleDataset(), enableArFeed(), ensureMotionTracking(), formatAngle(), formatAxis(), getArVideoScale(), getOrientationMode() (+16 more)
...
Cohesion: 0.03
Nodes (131): add(), addClassName(), addControl(), _addDefaultHandlers(), addTo(), _applyChanges(), _blockedByActive(), bp (+123 more)
...
Cohesion: 0.03
Nodes (93): addTileFeatures(), ah(), Am(), appendLeaves(), bm(), ch(), clear(), cluster() (+85 more)
...
Cohesion: 0.03
Nodes (97): ai(), allowVariableZoom(), allowWorldCopies(), _calcMatrices(), calculateCameraOptionsFromTo(), calculateCenterFromCameraLngLatAlt(), _calculateNearFarZIfNeeded(), _clearMatrixCaches() (+89 more)
...
Cohesion: 0.08
Nodes (22): buildOperatorAssetGrantCookieOptions(), ASSET_MANIFEST, createOperatorAssetHandler(), deny(), fs, handler, noStoreHeaders(), path (+14 more)

### Community 65 - "Wardriver RaID + BSS Backend Repair Plan"
Cohesion: 0.09
Nodes (26): apply(), clone(), cloneImages(), getGlyphs(), getImages(), _getImagesForIds(), getPerspectiveRatio(), _getStyleAndImages() (+18 more)
...
Cohesion: 0.04
Nodes (89): addImage(), addLayer(), addSource(), addSprite(), _afterImageUpdated(), _applyGlobalStateChanges(), ba(), _checkLoaded() (+81 more)
...
Cohesion: 0.22
Nodes (19): cameraForBoxAndBearing(), contains(), convert(), getEast(), getLesserNonNegativeNonNull(), getNorth(), getNorthEast(), getNorthWest() (+11 more)

### Community 79 - "index.js"
Cohesion: 0.29
Nodes (13): buildOperatorSessionCookieOptions(), requireOperatorToken(), { buildOperatorSessionCookieOptions, requireOperatorToken }, { createReleaseStore, toOperatorMetadata }, handle(), handleAuthorized(), handler(), isHttpsBlobUrl() (+5 more)

### Community 80 - "Cybermap Geospatial Backend Design"
Cohesion: 0.12
Nodes (33): _afterEase(), applyUpdatedTransform(), Cr(), dblclick(), _ease(), easeTo(), _finalizeElevation(), _fireMoveEvents() (+25 more)
...
Cohesion: 0.18
Nodes (7): getConfiguredDigest(), verifyPasscode(), {
...
Cohesion: 0.06
Nodes (45): _afterTileLoadWorkerResponse(), _applyResourceTiming(), _charUsesLocalIdeographFontFamily(), clearTextures(), _createTinySDF(), destroy(), _diffStyle(), _dispatchWorkerUpdate() (+37 more)

### Community 98 - "Requirements"
Cohesion: 0.13
Nodes (33): ac(), constrainInternal(), Ga(), gs(), handleEaseTo(), handleFlyTo(), handleJumpToCenterZoom(), _handleMapControls() (+25 more)
...
Cohesion: 0.04
Nodes (89): ac(), add(), addIndicesForPlacedSymbol(), as(), ax(), bs(), Bx(), concat() (+81 more)
...
Cohesion: 0.04
Nodes (66): acquireRTT(), _addTerrainIdealTiles(), bindRTT(), _cleanUpRasterTiles(), _clearSource(), _clearTileReloadTimer(), clearTiles(), commit() (+58 more)

### Community 111 - "Mosaic & Murmurs Autonomous Paper Engine"
Cohesion: 0.09
Nodes (26): kf(), _addCollisionDebugVertex(), addCollisionDebugVertices(), addDebugCollisionBoxes(), cp(), createNewSegment(), destroy(), destroyDebugData() (+18 more)
...
Cohesion: 0.16
Nodes (15): createOperatorToken(), { createOperatorToken }, invokeRoute(), makeOperatorHeaders(), require, restoreEnv(), TEST_OPERATOR_DIGEST, { createOperatorToken } (+7 more)
...
Cohesion: 0.06
Nodes (41): anyTilesAfterTime(), attemptAnchorPlacement(), _cleanUpVectorTiles(), clearSymbolFadeHold(), continuePlacement(), createFramebuffer(), createRenderbuffer(), _drainInertiaBuffer() (+33 more)
...
Cohesion: 0.05
Nodes (61): fov(), addLineDashDependencies(), Bi(), bo(), _calculate(), calculateGlyphDependencies(), checkSubtype(), co() (+53 more)

### Community 136 - "index.js"
Cohesion: 0.08
Nodes (49): gv(), url(), vv(), activeObjectUrls, api(), appendArtifactControls(), appendMetadata(), artifactFilename() (+41 more)
...
Cohesion: 0.14
Nodes (22): $a(), calculatePosMatrix(), co(), fo(), getFastPathSimpleProjectionMatrix(), go(), ho(), io() (+14 more)
...
Cohesion: 0.07
Nodes (52): bl(), cameraPosition(), _computeTileBoundingVolume(), Cs(), dispatchRenderCallbacks(), ec(), Fc(), fromAabb() (+44 more)

### Community 150 - "Recommended delivery sequence"
Cohesion: 0.05
Nodes (51): addImages(), af(), backfillBorder(), bc, bind(), completeTask(), constantOr(), constructor() (+43 more)
...
Cohesion: 0.08
Nodes (37): bbox(), dd(), Dm(), Em(), jg(), kg(), nextField(), Ng() (+29 more)
...
Cohesion: 0.08
Nodes (38): gestureBeginsVertically(), bf(), bp(), _colorRampChanged(), _createColorRamp(), dp(), ep(), ff() (+30 more)
...
Cohesion: 0.07
Nodes (48): ee(), H(), ji(), nl, rc(), te(), zn(), abort() (+40 more)
...
Cohesion: 0.06
Nodes (44): Ad(), ag(), at(), Cd(), convert(), _convertFromCellCoord(), _convertToCellCoord(), distSqr() (+36 more)
...
Cohesion: 0.05
Nodes (129): ad(), al(), bd(), bind(), _bindFramebuffer(), Bs(), Bu(), _buildSkirts() (+121 more)

### Community 181 - "implement.md"
Cohesion: 0.18
Nodes (33): ao(), _flattenAndSortRenderedFeatures(), oo(), queryRenderedFeatures(), b(), cc(), cg, D() (+25 more)
...
Cohesion: 0.09
Nodes (30): _addTile(), _areDescendentsComplete(), getAllIds(), _getLoadedDescendents(), getLoadedTile(), getRenderableIds(), getRTLTextPluginStatus(), getTileById() (+22 more)

### Community 192 - "addLine"
Cohesion: 0.11
Nodes (26): addCurrentVertex(), addFeature(), addFeatures(), addHalfVertex(), addLine(), addToLineVertexArray(), addToSortKeyRanges(), angleTo() (+18 more)
...
### Community 268 - "query"
Cohesion: 0.50
Nodes (8): activateTab(), activateTabByIndex(), bindTabSystem(), getTabButtons(), getTabPanels(), handleTabKeydown(), resetTabSelection(), setTabAria()
...
Cohesion: 0.08
Nodes (11): forbidden(), hashCanonicalJson(), hashPersistedObservation(), insertObservations(), normalizeDatabaseError(), PostgresObservationStore, pruneExpiredMorningBriefs(), REQUIRED_MIGRATIONS (+3 more)
...
- **Why does `error()` connect `Wu` to `index.js`, `tzeentch.mjs`, `postgres-store.test.mjs`, `Tasks: Static Web Application Functionality`, `BSS Cybermap API — authenticated observation ingest`, `index.js`, `greenfeed-worker.mjs`, `hashCanonicalJson`, `cybermap-ingest-api.test.mjs`, `global-viewport-http.test.mjs`, `Implementation Plan: Static Web Application Functionality`, `index.js`, `main.js`, `$`, `main.js`, `Recommended delivery sequence`, `server.mjs`?**
  _High betweenness centrality (0.096) - this node is a cross-community bridge._
- **Why does `key()` connect `wigle.mjs` to `index.js`, `postgres-store.test.mjs`, `operator-auth.js`, `deflock-viewport-contract.mjs`, `tzeentch-dashboard.mjs`, `index.js`, `global-viewport-http.test.mjs`, `cybermap-global-viewport-api.test.mjs`, `cybermap-viewport-api.test.mjs`, `morning-brief-api.test.mjs`, `contracts.mjs`, `validatePaperState`, `vision.mjs`, `index.js`, `server.mjs`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Why does `handleLogin()` connect `main.js` to `Wu`?**
