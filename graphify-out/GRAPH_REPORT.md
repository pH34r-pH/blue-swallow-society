# Graph Report - wardriver-mtls-header-overwrite  (2026-07-28)

## Corpus Check
- 343 files · ~313,750 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5886 nodes · 12441 edges · 321 communities (244 shown, 77 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 653 edges (avg confidence: 0.65)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2d49ffa7`
...
Cohesion: 0.12
Nodes (34): abortIfPresent(), abortInFlight(), bindTzeentchSurfaceTabs(), buildOperatorHeaders(), classifyEvidenceTags(), createEmptyTzeentchPayload(), buildTzeentchDashboardModel(), getTzeentchMarketModel() (+26 more)
...
Cohesion: 0.01
Nodes (161): aa(), acquire(), addBucket(), addDash(), addRegularDash(), addRoundDash(), af, ai() (+153 more)
...
Cohesion: 0.12
Nodes (39): activateGodeyeMode(), applyWigleDataset(), bindDeflockGlobalControls(), bindGodeyeControls(), bindGodeyeModeControls(), buildDeflockGlobalRequest(), buildOperatorHeaders(), getCurrentPosition() (+31 more)
...
Cohesion: 0.14
Nodes (29): boundedDiagnosticCode(), buildEchoPayload(), clampFiniteNumber(), createRequestHandler(), forbiddenWithDiagnostic(), handleCybermapTile(), handleGlobalViewport(), handleMorningBriefRequest() (+21 more)
...
Cohesion: 0.01
Nodes (140): ab(), addImageSection(), addTextSection(), ag(), angleWith(), angleWithSep(), ap, av() (+132 more)
...
}, buildRunId(), commit(), createReleaseStore(), isoTimestamp(), notes(), parseConnectionString(), positiveInt() (+14 more)

### Community 43 - "refreshLiveWigleFeed"
Cohesion: 0.02
Nodes (144): add(), addClassName(), _addDefaultHandlers(), addTo(), adjustAntiMeridian(), _applyChanges(), _blockedByActive(), bp (+136 more)
...
Cohesion: 0.03
Nodes (105): id(), Ad(), addTileFeatures(), ah(), Am(), appendLeaves(), bm(), Cd() (+97 more)
...
Cohesion: 0.10
Nodes (29): da(), di(), getPerspectiveRatio(), isInsideGrid(), isOffscreen(), lerp(), ll(), no() (+21 more)
...
Cohesion: 0.08
Nodes (26): canonicalJson(), GLOBAL_VIEWPORT_LAYER_IDS, MTLS_DIAGNOSTIC_CODES, PAPER_ACTION_KEYS, PAPER_ARCHIVE_KEYS, PAPER_BOOK_COST_KEYS, PAPER_BOOK_IDS, PAPER_BOOK_KEYS (+18 more)
...
Cohesion: 0.04
Nodes (94): addControl(), addImage(), addLayer(), addSource(), addSprite(), _afterImageUpdated(), _applyGlobalStateChanges(), ba() (+86 more)
...
Cohesion: 0.28
Nodes (14): requireOperatorToken(), toOperatorMetadata(), acceptsDownloadUrl(), { createReleaseStore, toOperatorMetadata }, downloadUrlResponse(), handle(), handleAuthorized(), handler() (+6 more)

### Community 80 - "Cybermap Geospatial Backend Design"
Cohesion: 0.05
Nodes (55): $a(), calculatePosMatrix(), co(), coordinatePoint(), depthAtPoint(), extend(), fo(), getBounds() (+47 more)
...
Cohesion: 0.10
Nodes (25): add(), addIndicesForPlacedSymbol(), clear(), createTree(), filter(), filterUpdate(), finish(), getAndRemove() (+17 more)
...
### Community 95 - "add"
Cohesion: 0.11
Nodes (25): bbox(), dd(), gv(), jg(), kg(), loadGeometry(), nextField(), Ng() (+17 more)
...
Cohesion: 0.06
Nodes (49): _afterTileLoadWorkerResponse(), _applyResourceTiming(), _charUsesLocalIdeographFontFamily(), clearTextures(), _createStyleImage(), _createTinySDF(), destroy(), _diffStyle() (+41 more)
...
Cohesion: 0.05
Nodes (70): ac(), as(), at(), ax(), bind(), bs(), Bx(), concat() (+62 more)
...
Cohesion: 0.06
Nodes (35): containsMaxSafeIntegerValues(), dc(), deserialize(), expandBy(), extend(), fc(), freeBufferAfterUpload(), fromPoints() (+27 more)

### Community 111 - "Mosaic & Murmurs Autonomous Paper Engine"
Cohesion: 0.14
Nodes (28): createEmptyState(), formatPaperQuantity(), formatPaperUsd(), formatTimestamp(), renderActionableCard(), renderActionablePanel(), renderChipStrip(), renderCryptoIcon() (+20 more)
...
Cohesion: 0.04
Nodes (78): addLineDashDependencies(), af(), bc, bo(), _calculate(), calculateGlyphDependencies(), cg, checkSubtype() (+70 more)
...
Cohesion: 0.06
Nodes (48): addCurrentVertex(), addFeature(), addFeatures(), addHalfVertex(), addLine(), addToLineVertexArray(), addToSortKeyRanges(), angleTo() (+40 more)
...
Cohesion: 0.03
Nodes (94): _addTerrainIdealTiles(), _addTile(), allowWorldCopies(), _areDescendentsComplete(), _cleanUpRasterTiles(), _cleanUpVectorTiles(), _clearSource(), clearSymbolFadeHold() (+86 more)
...
Cohesion: 0.07
Nodes (50): bl(), Ca(), _computeTileBoundingVolume(), Cs(), ec(), Fc(), fromAabb(), fromCenterSizeAngles() (+42 more)

### Community 150 - "Recommended delivery sequence"
Cohesion: 0.06
Nodes (41): addImages(), backfillBorder(), cn, completeTask(), constructor(), copy(), _down(), fd() (+33 more)
...
Cohesion: 0.18
Nodes (18): IngestError, handleCybermapViewportPost(), handleOperatorSignalSnapshotPost(), readJsonRequestBody(), clampFiniteNumber(), finiteOrNull(), isPlainObject(), labelForKind() (+10 more)
...
### Community 157 - "ud"
Cohesion: 0.05
Nodes (120): ad(), al(), ao(), bd(), bind(), _bindFramebuffer(), Bs(), Bu() (+112 more)
...
Cohesion: 0.07
Nodes (48): an(), D(), gn(), I, ln, rn(), tn(), Xn() (+40 more)
...
Cohesion: 0.06
Nodes (43): acquireRTT(), anyTilesAfterTime(), attemptAnchorPlacement(), bindRTT(), commit(), continuePlacement(), _finalizeElevation(), getAnisotropicFilterPitch() (+35 more)
...
### Community 269 - "query"
Cohesion: 0.12
Nodes (22): addSymbols(), cp(), createNewSegment(), emplace(), feature(), forceNewSegmentOnNextPrepare(), getOrCreateLatestSegment(), getPositionIds() (+14 more)
...
### Community 277 - "xt"
Cohesion: 0.04
Nodes (153): ac(), _afterEase(), allowVariableZoom(), apply(), applyUpdatedTransform(), _calcMatrices(), calculateCameraOptionsFromTo(), calculateCenterFromCameraLngLatAlt() (+145 more)
...
- **Why does `error()` connect `morning-brief-api.test.mjs` to `index.js`, `postgres-store.test.mjs`, `hashCanonicalJson`, `BSS Cybermap API — authenticated observation ingest`, `index.js`, `greenfeed-worker.mjs`, `Implementation Plan: Static Web Application Functionality`, `index.js`, `main.js`, `$`, `main.js`, `Recommended delivery sequence`, `adapter-contract.mjs`, `morning-brief.test.mjs`, `server.mjs`?**
  _High betweenness centrality (0.085) - this node is a cross-community bridge._
- **Why does `key()` connect `tzeentch.mjs` to `index.js`, `tzeentch-dashboard.mjs`, `wigle.mjs`, `createIndexBuffer`, `$`, `_executeRelevantHandler`, `cybermap-tiles-api.test.mjs`, `vision.mjs`, `server.mjs`, `postgres-store.test.mjs`, `operator-auth.js`, `clear`, `contracts.mjs`, `validatePaperState`, `deflock-viewport-contract.mjs`, `validatePaperState`, `Wu`, `cybermap-global-viewport-api.test.mjs`, `cybermap-viewport-api.test.mjs`?**
