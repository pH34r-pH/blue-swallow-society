# Graph Report - blue-swallow-society  (2026-08-10)

## Corpus Check
- 394 files · ~338,627 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6213 nodes · 13333 edges · 307 communities (258 shown, 49 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 671 edges (avg confidence: 0.65)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `dbfae54d`
...
## Communities (307 total, 49 thin omitted)
...
Cohesion: 0.08
Nodes (8): ExecutionCostAccountingTests, AutonomousPaperEngineTests, fresh_snapshot(), instrument(), iso_z(), load_engine(), datetime, MosaicMurmursPaperMemoryLoopTest
...
Cohesion: 0.01
Nodes (164): aa(), acquire(), addBucket(), addDash(), addRegularDash(), addRoundDash(), af, _applyDiffToSource() (+156 more)
...
### Community 13 - "memory-store.mjs"
Cohesion: 0.07
Nodes (27): aggregateCaveats(), aggregateFreshness(), boundedGlobalLimit(), briefSummary(), cellUsesOnlyEligibleLayers(), centroidInBbox(), cloneBrief(), compareAggregateCells() (+19 more)

### Community 14 - "mosaic_murmurs_paper_engine.py"
Cohesion: 0.05
...
Cohesion: 0.06
Nodes (51): Am(), bbox(), bm(), Dm(), eh(), Em(), fm(), jg() (+43 more)

### Community 17 - "main.js"
Cohesion: 0.10
Nodes (45): clearGodeyeSessionAnalysis(), deriveGodeyeSessionAnalysis(), validRecord(), activateGodeyeMode(), applyWigleDataset(), bindDeflockGlobalControls(), bindGodeyeControls(), bindGodeyeModeControls() (+37 more)
...
### Community 22 - "Azure Resources Specification"
Cohesion: 0.07
...
### Community 23 - "Static Web App Styling"
Cohesion: 0.07
...
Cohesion: 0.09
Nodes (23): bleBatch(), credential(), hashToken(), tokenDigestMatches(), NOW, ingestHeaders(), validBatch(), validObservation() (+15 more)
...
### Community 31 - "Tasks: [FEATURE NAME]"
Cohesion: 0.22
Nodes (18): clip(), _eligible_instrument(), finite_number(), generate_shadow_candidates(), iso_z(), iso_z_precise(), mature_experiences(), _normalize_weights() (+10 more)

### Community 32 - "SKILL.md"
Cohesion: 0.08
Nodes (25): 1. Initialize Analysis Context, 2. Load Artifacts (Progressive Disclosure), 3. Build Semantic Models, 4. Detection Passes (Token-Efficient Analysis), 5. Severity Assignment, 6. Produce Compact Analysis Report, 7. Provide Next Actions, 8. Offer Remediation (+17 more)

### Community 33 - "Mosaic & Murmurs Paper Memory Loop"
Cohesion: 0.13
Nodes (24): readProtectedRegularFile(), API_ROOT, exactPath(), execFileAsync, EXPECTED_CREDENTIAL_ROOT, EXPECTED_DESKTOP_PUBLIC_CERTIFICATE, EXPECTED_LOCAL_CA_CERT, EXPECTED_LOCAL_CLIENT_P12 (+16 more)

### Community 34 - "mosaic-murmurs-morning-brief-render.py"
Cohesion: 0.21
Nodes (25): FreeTypeFont, ImageDraw, ImageFont, build_pages(), canonical_json(), _font(), iso_z(), main() (+17 more)

### Community 35 - "analyze.md"
Cohesion: 0.08
...
Cohesion: 0.01
Nodes (112): ab(), addImageSection(), addTextSection(), angleWith(), angleWithSep(), ap, av(), ay() (+104 more)
...
### Community 40 - "Tasks: VM Echo API"
Cohesion: 0.08
Nodes (24): Dependencies & Execution Order, Format: `[ID] [P?] [Story] Description`, Implementation for User Story 1, Implementation for User Story 2, Implementation for User Story 3, Implementation for User Story 4, Notes, Parallel Opportunities (+16 more)

### Community 41 - "Tasks: Azure Infrastructure Deployment"
Cohesion: 0.08
Nodes (24): Dependencies & Execution Order, Format: `[ID] [P?] [Story] Description`, Implementation for User Story 1, Implementation for User Story 2, Implementation for User Story 3, Implementation for User Story 4, Notes, Parallel Opportunities (+16 more)

### Community 42 - "wardriver-release-store.js"
Cohesion: 0.10
...
Cohesion: 0.03
Nodes (132): $a(), add(), addClassName(), _addDefaultHandlers(), addTo(), _applyChanges(), _blockedByActive(), bp (+124 more)
...
### Community 45 - "osint-applications.mjs"
Cohesion: 0.19
...
Cohesion: 0.04
Nodes (82): addIndicesForPlacedSymbol(), addTileFeatures(), ah(), appendLeaves(), bn(), ch(), clear(), cluster() (+74 more)
...
### Community 48 - "Implementation Plan: Azure Infrastructure Deployment"
Cohesion: 0.08
...
### Community 49 - "Proposal: Mosaic & Murmurs Morning Brief"
Cohesion: 0.09
...
### Community 54 - "Anti-Surveillance Style Research"
Cohesion: 0.09
...
### Community 55 - "Mosaic & Murmurs Dream Consolidation Proposal"
Cohesion: 0.09
...
Cohesion: 0.11
Nodes (22): _charUsesLocalIdeographFontFamily(), _createTinySDF(), _diffStyle(), _downloadAndCacheRangePromise(), _drawGlyph(), _fontStyle(), _fontWeight(), _getAndCacheGlyphsPromise() (+14 more)
...
### Community 60 - "Proposal: Mosaic & Murmurs Breach Mirror Self-Pentest"
Cohesion: 0.12
...
Cohesion: 0.07
Nodes (41): Bi(), bo(), checkSubtype(), co(), compare(), crossFadingFactor(), Do(), dr() (+33 more)
...
Cohesion: 0.09
Nodes (39): _calculateTransform(), contextmenu(), dblclick(), dragEnd(), dragMove(), dragStart(), _f(), ff() (+31 more)
...
### Community 67 - "Implementation Plan: Wardriver Immutable Release Delivery"
Cohesion: 0.10
...
### Community 70 - "Public Official and Political Signal Radar"
Cohesion: 0.10
Nodes (20): Additional Security Requirements, API Security, Authentication and Authorization, Blue Swallow Society Constitution, Code Review Security Focus, Core Principles, Data Protection, Dependency Management (+12 more)

### Community 71 - "godeye-global.mjs"
Cohesion: 0.03
Nodes (114): addControl(), addImage(), addLayer(), addSource(), addSprite(), _afterImageUpdated(), _afterTileLoadWorkerResponse(), _applyGlobalStateChanges() (+106 more)

### Community 72 - "package.json"
Cohesion: 0.12
Nodes (15): h3-js, pg, dependencies, h3-js, pg, engines, node, name (+7 more)

### Community 73 - "common.ps1"
Cohesion: 0.26
...
### Community 74 - "ui-shell.test.mjs"
Cohesion: 0.12
...
### Community 78 - "greenfeed-materializer.test.mjs"
Cohesion: 0.11
...
### Community 84 - "concat"
Cohesion: 0.15
Nodes (17): addCurrentVertex(), addHalfVertex(), addLine(), clone(), div(), divByPoint(), mag(), matMult() (+9 more)

### Community 85 - "Feature Specification: [FEATURE NAME]"
Cohesion: 0.11
...
### Community 86 - "006 — Morning Brief Field Dossier"
Cohesion: 0.12
Nodes (4): get_current_branch(), get_feature_paths(), has_git(), common.sh script

### Community 87 - "Research: World Monitor Source Breadth and BSS Selection"
Cohesion: 0.11
...
### Community 94 - "tzeentch-route.test.mjs"
Cohesion: 0.20
...
### Community 95 - "add"
Cohesion: 0.03
Nodes (113): acquireRTT(), _addTerrainIdealTiles(), _addTile(), anyTilesAfterTime(), _areDescendentsComplete(), bindRTT(), _cleanUpRasterTiles(), _cleanUpVectorTiles() (+105 more)

### Community 96 - "Core Principles"
Cohesion: 0.13
...
Cohesion: 0.07
Nodes (66): createGodeyeController(), activateTab(), activateTabByIndex(), applyVisionDataset(), bindMorningBriefReturn(), bindOperatorDownloads(), bindTabSystem(), bindVisionControls() (+58 more)
...
### Community 100 - "PaperMarketDataTests"
Cohesion: 0.13
...
### Community 101 - "tzeentch-browser.test.mjs"
Cohesion: 0.15
...
### Community 104 - "Static Web App Functionality"
Cohesion: 0.40
...
### Community 114 - "Implementation Plan: Adversarial Surface Remediation and Tool-First Operator UI"
Cohesion: 0.14
...
Cohesion: 0.14
Nodes (12): Affected Files, Approach, Implementation Plan: Wardriver mTLS Proxy Secret Delivery, Root Cause, Security Boundary, Edge Cases, Feature Specification: Wardriver mTLS Proxy Secret Delivery, Functional Requirements (+4 more)

### Community 119 - "clamp"
Cohesion: 0.05
Nodes (61): q, bg(), calculateScaledKey(), determineAverageLineWidth(), determineLineBreaks(), Dv(), ev(), fromLngLat() (+53 more)
...
### Community 124 - "Azure Credentials Setup (OIDC, no secrets in GitHub)"
Cohesion: 0.15
...
### Community 125 - "mosaic-and-murmurs-operating-doctrine.md"
Cohesion: 0.15
...
### Community 126 - "Nacre-Moiré operator design system"
Cohesion: 0.18
...
Cohesion: 0.06
Nodes (46): id(), Ad(), ag(), at(), Cd(), convert(), _convertFromCellCoord(), _convertToCellCoord() (+38 more)
...
### Community 132 - "Tasks: Godeye Global Map and Source Integration"
Cohesion: 0.17
...
### Community 133 - "Feature Specification: Adversarial Surface Remediation and Tool-First Operator UI"
Cohesion: 0.18
Nodes (10): Core Principles, Governance, [PRINCIPLE_1_NAME], [PRINCIPLE_2_NAME], [PRINCIPLE_3_NAME], [PRINCIPLE_4_NAME], [PRINCIPLE_5_NAME], [PROJECT_NAME] Constitution (+2 more)

### Community 134 - "root-login-handoff-browser.test.mjs"
Cohesion: 0.25
...
Cohesion: 0.14
Nodes (31): handleLogout(), activeObjectUrls, api(), appendArtifactControls(), appendMetadata(), artifactFilename(), artifactHref(), detailNode (+23 more)

### Community 137 - "Safe options"
Cohesion: 0.09
Nodes (27): attemptAnchorPlacement(), getPerspectiveRatio(), isInsideGrid(), isOffscreen(), jo(), lerp(), markUsedJustification(), markUsedOrientation() (+19 more)

### Community 138 - "getTile"
Cohesion: 0.18
...
### Community 139 - "006 — Field Dossier Production Design"
Cohesion: 0.18
...
### Community 140 - "auth.mjs"
Cohesion: 0.18
Nodes (17): adjustAntiMeridian(), cameraForBounds(), _fireEvent(), fitBounds(), _fitInternal(), fitScreenCoordinates(), getEast(), getNorth() (+9 more)

### Community 141 - "query"
Cohesion: 0.11
Nodes (24): _addCollisionDebugVertex(), addCollisionDebugVertices(), addSymbols(), cp(), createNewSegment(), emplace(), feature(), forceNewSegmentOnNextPrepare() (+16 more)

### Community 142 - "wardriver-basemap-delivery-config.test.mjs"
Cohesion: 0.33
Nodes (6): parseJson(), publicationWorkflow, read(), root, storageModule, styleTemplate

### Community 144 - "createIndexBuffer"
Cohesion: 0.17
...
### Community 147 - "Tzeentch Paper API Status"
Cohesion: 0.24
Nodes (6): forbidden(), hashCanonicalJson(), hashPersistedObservation(), unscopedObservationIdentity(), insertObservations(), touchCredential()

### Community 148 - "local-server.js"
Cohesion: 0.16
Nodes (8): APP_DIR, createLocalServer(), fs, http, path, startLocalServer(), require, root

### Community 149 - "extract-mbtiles-tiles.py"
Cohesion: 0.08
Nodes (43): cameraPosition(), _computeTileBoundingVolume(), Cs(), ec(), fromAabb(), fromCenterSizeAngles(), fromInvProjectionMatrix(), getCameraFrustum() (+35 more)

### Community 150 - "Recommended delivery sequence"
Cohesion: 0.04
Nodes (54): setState(), addImages(), backfillBorder(), bind(), bt(), cn, completeTask(), constructor() (+46 more)

### Community 151 - "Tasks: Wardriver Immutable Release Delivery"
Cohesion: 0.20
...
### Community 153 - "Implementation Plan: Wardriver Release-Probe Verification"
Cohesion: 0.12
...
### Community 154 - "_executeRelevantHandler"
Cohesion: 0.27
...
### Community 156 - "SKILL.md"
Cohesion: 0.24
Nodes (3): FakeResponse, load_module(), PaperSyncTests

### Community 157 - "ud"
Cohesion: 0.05
Nodes (129): ad(), al(), bd(), bind(), _bindFramebuffer(), bl(), Bs(), Bu() (+121 more)

### Community 158 - "Recommended delivery sequence"
Cohesion: 0.08
Nodes (43): aa(), ao(), ba(), ca(), canonicalID(), da(), distance(), _down() (+35 more)
...
### Community 161 - "render-wardriver-basemap-style.py"
Cohesion: 0.22
...
### Community 162 - "[CHECKLIST TYPE] Checklist: [FEATURE NAME]"
Cohesion: 0.25
Nodes (3): _extract_highest_number(), get_highest_from_branches(), create-new-feature.sh script

### Community 163 - "global-viewport-contract.test.mjs"
Cohesion: 0.22
Nodes (8): Complexity Tracking, Constitution Check, Documentation (this feature), Implementation Plan: [FEATURE], Project Structure, Source Code (repository root), Summary, Technical Context

### Community 164 - "constitution.md"
Cohesion: 0.08
Nodes (39): bf(), bp(), _colorRampChanged(), _createColorRamp(), dp(), ep(), ff(), fp() (+31 more)
...
### Community 166 - "Test Design: Wardriver Immutable Release Delivery"
Cohesion: 0.25
...
### Community 167 - "Implementation Status: Godeye Global Map and Source Integration"
Cohesion: 0.25
Nodes (7): Anti-Examples: What NOT To Do, Checklist Purpose: "Unit Tests for English", Example Checklist Types & Sample Items, Execution Steps, Post-Execution Checks, Pre-Execution Checks, User Input

### Community 168 - "Test Design: Adversarial Surface Remediation and Tool-First Operator UI"
Cohesion: 0.25
Nodes (7): Key rules, Outline, Phase 0: Outline & Research, Phase 1: Design & Contracts, Phases, Pre-Execution Checks, User Input

### Community 169 - "Plan: Wardriver MapLibre Basemap"
Cohesion: 0.25
...
### Community 172 - "runtime-versions.test.mjs"
Cohesion: 0.50
Nodes (4): read(), readJson(), root, workflowPaths

### Community 173 - "wardriver-release-delivery-config.test.mjs"
Cohesion: 0.40
Nodes (4): main, moduleUrl, root, workflow

### Community 174 - "clear"
Cohesion: 0.08
Nodes (16): IngestError, createCybermapApiServer(), request, GlobalViewportStore, postGlobalViewport(), VALID_REQUEST, VALID_RESPONSE, withServer() (+8 more)
...
### Community 177 - "greenfeed-materializer.test.mjs"
Cohesion: 0.20
...
### Community 178 - "Mosaic & Murmurs proposal delta"
Cohesion: 0.25
...
### Community 180 - "renderLayer"
Cohesion: 0.05
Nodes (55): ai(), allowVariableZoom(), allowWorldCopies(), calculateCameraOptionsFromTo(), calculateCenterFromCameraLngLatAlt(), createFramebuffer(), createRenderbuffer(), depthAtPoint() (+47 more)
...
### Community 185 - "validatePaperState"
Cohesion: 0.26
...
### Community 188 - "Microsoft Entra External ID setup checklist"
Cohesion: 0.50
Nodes (3): renderer, root, template

### Community 189 - "Tests: Wardriver MapLibre Basemap"
Cohesion: 0.25
Nodes (7): Key rules, Outline, Phase 0: Outline & Research, Phase 1: Design & Contracts, Phases, Pre-Execution Checks, User Input
...
### Community 191 - "tzeentch-demo-data.mjs"
Cohesion: 0.25
Nodes (7): Checklist Format (REQUIRED), Outline, Phase Structure, Pre-Execution Checks, Task Generation Rules, Task Organization, User Input
...
### Community 193 - "0004_godeye_global_cells_and_sources.sql"
Cohesion: 0.25
...
### Community 195 - "print-next-steps.sh"
Cohesion: 0.25
...
### Community 196 - "check-prerequisites.sh"
Cohesion: 0.29
...
### Community 212 - "getElevation"
Cohesion: 0.05
Nodes (126): ac(), _afterEase(), ao(), apply(), applyUpdatedTransform(), _calcMatrices(), _calculateNearFarZIfNeeded(), cameraForBoxAndBearing() (+118 more)
...
### Community 218 - "Connection"
Cohesion: 0.53
Nodes (3): load_bridge_module(), Path, WigleLocalBridgeTests

### Community 219 - "Namespace"
Cohesion: 0.40
Nodes (4): Outline, Post-Execution Checks, Pre-Execution Checks, User Input

### Community 220 - "local-dev.ps1"
Cohesion: 0.40
Nodes (4): Outline, Post-Execution Checks, Pre-Execution Checks, User Input
...
### Community 228 - "datetime"
Cohesion: 0.40
Nodes (4): Outline, Post-Execution Checks, Pre-Execution Checks, User Input

### Community 229 - "Namespace"
Cohesion: 0.40
...
### Community 276 - "Product Surfaces"
Cohesion: 0.22
Nodes (5): GDACS_ALERTS_ADAPTER, NASA_EONET_EVENTS_ADAPTER, USGS_EARTHQUAKES_ADAPTER, ADAPTERS, FIXTURE_DIRECTORY

### Community 277 - "xt"
Cohesion: 0.04
Nodes (72): addDebugCollisionBoxes(), addFeature(), addFeatures(), addLineDashDependencies(), af(), an(), bc, _calculate() (+64 more)

### Community 282 - "cybermap-tiles-api.test.mjs"
Cohesion: 0.39
Nodes (6): closeBoundary(), DEFLOCK_H3_RESOLUTIONS, materializeDeflockReports(), normalizePoint(), validTimestamp(), reports

### Community 286 - "serialize"
Cohesion: 0.07
Nodes (28): containsMaxSafeIntegerValues(), dc(), deserialize(), extend(), fc(), freeBufferAfterUpload(), fromPoints(), getFeatures() (+20 more)

### Community 294 - "hashCanonicalJson"
Cohesion: 0.06
Nodes (44): deriveWardriverProgress(), aggregateCaveats(), aggregateFreshness(), aggregateLayers(), aggregateSourceClasses(), bindMtlsCredentialPolicy(), boundedGlobalLimit(), canonicalizeJson() (+36 more)

### Community 295 - "Test Design: Wardriver Release-Probe Verification"
Cohesion: 0.40
Nodes (4): TDD sequence, Test Design: Wardriver Release-Probe Verification, Test matrix, Traceability

### Community 297 - "index.js"
Cohesion: 0.33
Nodes (3): { requireOperatorToken }, sendJson(), unavailable()

### Community 302 - "Cybermap database migrations"
Cohesion: 0.50
...
## Knowledge Gaps
- **1596 isolated node(s):** `check-prerequisites.sh script`, `common.sh script`, `create-new-feature.sh script`, `setup-plan.sh script`, `setup-tasks.sh script` (+1591 more)
...
- **Why does `error()` connect `Requirements` to `index.js`, `checklist.md`, `index.js`, `main.js`, `Tzeentch Paper API Status`, `$`, `main.js`, `Recommended delivery sequence`, `adapter-contract.mjs`, `server.mjs`, `Mosaic & Murmurs Paper Memory Loop`, `postgres-store.test.mjs`, `hashCanonicalJson`, `Implementation Plan: Static Web Application Functionality`, `clear`, `validatePaperState`, `index.js`, `hashCanonicalJson`, `Mosaic & Murmurs Autonomous Paper Engine`, `Nacre-Moiré operator design system`?**
  _High betweenness centrality (0.088) - this node is a cross-community bridge._
- **Why does `key()` connect `contracts.mjs` to `index.js`, `plan.md`, `tzeentch.mjs`, `tzeentch-dashboard.mjs`, `wigle.mjs`, `createIndexBuffer`, `$`, `vision.mjs`, `_executeRelevantHandler`, `server.mjs`, `postgres-store.test.mjs`, `operator-auth.js`, `hashCanonicalJson`, `clear`, `greenfeed-materializer.test.mjs`, `validatePaperState`, `deflock-viewport-contract.mjs`, `key`, `Wu`, `index.js`, `hashCanonicalJson`, `cybermap-global-viewport-api.test.mjs`, `cybermap-viewport-api.test.mjs`?**
  _High betweenness centrality (0.078) - this node is a cross-community bridge._
- **Why does `record()` connect `add` to `tzeentch.mjs`, `wigle.mjs`, `morning-brief.mjs`, `global-viewport-contract.mjs`, `vision.mjs`, `server.mjs`?**
