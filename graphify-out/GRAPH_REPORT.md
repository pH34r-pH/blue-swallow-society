# Graph Report - blue-swallow-society  (2026-07-29)

## Corpus Check
- 376 files · ~334,094 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6131 nodes · 12889 edges · 336 communities (253 shown, 83 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 665 edges (avg confidence: 0.65)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2e905d37`
...
## Communities (336 total, 83 thin omitted)
...
Cohesion: 0.05
Nodes (72): key(), annotateCurrentRecord(), bearingBetween(), buildArCandidateBoxes(), buildCurrentWigleState(), buildWigleMapState(), categorizeSignal(), cleanString() (+64 more)

### Community 4 - "mosaic-murmurs-paper-memory-loop.py"
Cohesion: 0.04
Nodes (44): API Endpoints, Authentication & Authorization, Azure Function Implementation (`api/echo/index.js`), Azure Functions Proxy Layer, cloud-init Provisioning, Configuration Points, Current Limitations, Current State (+36 more)
...
Cohesion: 0.15
Nodes (29): abortIfPresent(), abortInFlight(), bindTzeentchSurfaceTabs(), buildOperatorHeaders(), formatTimestamp(), initTzeentchDashboard(), loadOverview(), loadTzeentchMarketFeed() (+21 more)

### Community 9 - "wigle.mjs"
Cohesion: 0.09
Nodes (53): createGodeyeController(), buildTileGrid(), clamp(), latLonToTileXY(), metersPerPixel(), tileUrl(), wrapTileIndex(), annotateCurrentRecord() (+45 more)

### Community 10 - "morning-brief.mjs"
Cohesion: 0.01
Nodes (144): aa(), acquire(), addBucket(), addDash(), addRegularDash(), addRoundDash(), af, _applyDiffToSource() (+136 more)
...
Cohesion: 0.06
Nodes (29): forbidden(), aggregateCaveats(), aggregateFreshness(), boundedGlobalLimit(), briefSummary(), cellUsesOnlyEligibleLayers(), centroidInBbox(), cloneBrief() (+21 more)
...
Cohesion: 0.08
Nodes (76): serializeGodeyeLayerSearch(), activateGodeyeMode(), applyWigleDataset(), bindDeflockGlobalControls(), bindGodeyeControls(), bindGodeyeModeControls(), buildDeflockGlobalRequest(), DEFLOCK_GLOBAL_BBOX (+68 more)

### Community 17 - "main.js"
Cohesion: 0.12
Nodes (26): activateTab(), activateTabByIndex(), bindMorningBriefReturn(), bindOperatorDownloads(), bindTabSystem(), bootOperatorSurface(), buildOperatorHeaders(), compactFingerprint() (+18 more)
...
### Community 20 - "$"
Cohesion: 0.10
Nodes (22): getOperatorTokenSigningKey(), AzureTablePasscodeRateLimiter, callerKeyForRequest(), createPasscodeRateLimiter(), createTableClient(), crypto, firstForwardedAddress(), getBoundedPositiveInt() (+14 more)
...
Cohesion: 0.06
Nodes (33): bleBatch(), credential(), hashToken(), tokenDigestMatches(), hashPersistedObservation(), createCybermapApiServer(), NOW, request (+25 more)

### Community 29 - "server.mjs"
Cohesion: 0.07
Nodes (63): boundedDiagnosticCode(), buildEchoPayload(), canonicalJson(), clampFiniteNumber(), createRequestHandler(), forbiddenWithDiagnostic(), GLOBAL_VIEWPORT_LAYER_IDS, handleCybermapTile() (+55 more)
...
Cohesion: 0.20
Nodes (21): FreeTypeFont, build_pages(), canonical_json(), _font(), iso_z(), main(), parse_args(), parse_time() (+13 more)
...
Cohesion: 0.01
Nodes (155): ab(), addImageSection(), addTextSection(), angleWith(), angleWithSep(), ap, ay(), bb() (+147 more)

### Community 37 - "operator-auth.js"
Cohesion: 0.08
Nodes (25): { requireOperatorToken }, base64UrlDecode(), base64UrlEncode(), buildClearOperatorSessionCookie(), buildOperatorSessionCookie(), createOperatorToken(), crypto, extractCookieValue() (+17 more)
...
Cohesion: 0.03
Nodes (110): add(), addClassName(), addControl(), _addDefaultHandlers(), addTo(), _applyChanges(), _blockedByActive(), bp (+102 more)
...
Cohesion: 0.05
Nodes (76): addTileFeatures(), ah(), Am(), appendLeaves(), bm(), ch(), cluster(), _convertIndices() (+68 more)

### Community 47 - "Implementation Plan: Static Web Application Styling"
Cohesion: 0.22
Nodes (8): Complexity Tracking, Constitution Check, Documentation (this feature), Implementation Plan: Static Web Application Styling, Project Structure, Source Code (repository root), Summary, Technical Context
...
Cohesion: 0.12
Nodes (29): assertJsonValue(), BATCH_V1_FIELDS, BATCH_V2_FIELDS, ContractError, deepFreeze(), isPlainObject(), LOCATION_FIELDS, OBSERVATION_FIELDS (+21 more)

### Community 53 - "wigle-local-bridge.py"
Cohesion: 0.20
Nodes (14): BaseHTTPRequestHandler, _connect_readonly(), _distance_meters(), _iso_from_ms(), main(), make_handler(), query_current_state(), _query_latest_route() (+6 more)
...
Cohesion: 0.05
Nodes (59): _afterTileLoadWorkerResponse(), _applyResourceTiming(), attemptAnchorPlacement(), _charUsesLocalIdeographFontFamily(), _createTinySDF(), _diffStyle(), _dispatchWorkerUpdate(), _downloadAndCacheRangePromise() (+51 more)
...
Cohesion: 0.16
Nodes (20): BBOX_FIELDS, buildDeflockViewportResponse(), CELL_FIELDS, CENTROID_FIELDS, DeflockViewportError, finite(), LAYER_IDS, rejectUnknown() (+12 more)
...
Cohesion: 0.10
Nodes (28): fov(), bo(), checkSubtype(), co(), Do(), dr(), eachChild(), er (+20 more)
...
Cohesion: 0.12
Nodes (11): fs, path, PRIVATE_OPERATOR_DIR, { requireOperatorToken }, SHELL_PATH, { createOperatorToken }, handler, invoke() (+3 more)

### Community 65 - "Wardriver RaID + BSS Backend Repair Plan"
Cohesion: 0.08
Nodes (38): bbox(), Dm(), Em(), jg(), jv(), kg(), kv(), loadGeometry() (+30 more)
...
Cohesion: 0.04
Nodes (88): addImage(), addLayer(), addSource(), addSprite(), _afterImageUpdated(), _applyGlobalStateChanges(), ba(), _checkLoaded() (+80 more)
...
Cohesion: 0.04
Nodes (90): _afterEase(), apply(), applyUpdatedTransform(), _calcMatrices(), _calculateTransform(), _clearMatrixCaches(), clearNearFarZOverride(), _computeClippingPlane() (+82 more)

### Community 79 - "index.js"
Cohesion: 0.30
Nodes (13): requireOperatorToken(), acceptsDownloadUrl(), { createReleaseStore, toOperatorMetadata }, downloadUrlResponse(), handle(), handleAuthorized(), handler(), isHttpsBlobUrl() (+5 more)

### Community 80 - "Cybermap Geospatial Backend Design"
Cohesion: 0.05
Nodes (51): calculatePosMatrix(), clone(), cloneImages(), da(), di(), getCartesianPosition(), getFastPathSimpleProjectionMatrix(), getGlyphs() (+43 more)
...
Cohesion: 0.11
Nodes (27): addCurrentVertex(), addFeature(), addFeatures(), addHalfVertex(), addLine(), addToLineVertexArray(), addToSortKeyRanges(), angleTo() (+19 more)

### Community 84 - "raid-model-store.mjs"
Cohesion: 0.12
Nodes (16): release(), hashCanonicalJson(), selectCatalogReleases(), claimPostgresTrainingJob(), feedbackReceipt(), isReleaseTrusted(), isTrainingEventState(), MemoryRaIDModelStore (+8 more)
...
Cohesion: 0.35
Nodes (4): iso(), load_module(), manifest(), MorningBriefPublisherTests
...
### Community 95 - "add"
Cohesion: 0.03
Nodes (88): _addTerrainIdealTiles(), _addTile(), _areDescendentsComplete(), _cleanUpRasterTiles(), _cleanUpVectorTiles(), _clearSource(), clearSymbolFadeHold(), _clearTileReloadTimer() (+80 more)
...
Cohesion: 0.08
Nodes (25): containsMaxSafeIntegerValues(), dc(), deserialize(), extend(), fc(), freeBufferAfterUpload(), fromPoints(), getFeatures() (+17 more)
...
Cohesion: 0.17
Nodes (11): @azure/data-tables, @azure/storage-blob, dependencies, @azure/data-tables, @azure/storage-blob, description, engines, node (+3 more)
...
Cohesion: 0.04
Nodes (98): ac(), add(), addIndicesForPlacedSymbol(), as(), ax(), bind(), bs(), Bx() (+90 more)
...
Cohesion: 0.24
Nodes (20): createFixtureOnlyAdapter(), createSnapshot(), freezeSource(), invalidPayload(), normalizeClassification(), requireArray(), requireFiniteNumber(), requireLocation() (+12 more)

### Community 111 - "Mosaic & Murmurs Autonomous Paper Engine"
Cohesion: 0.12
Nodes (32): classifyEvidenceTags(), createEmptyState(), createEmptyTzeentchPayload(), formatPaperQuantity(), formatPaperUsd(), getTzeentchMarketModel(), renderActionableCard(), renderActionablePanel() (+24 more)
...
### Community 119 - "clamp"
Cohesion: 0.04
Nodes (67): na(), av(), bg(), calculateScaledKey(), determineAverageLineWidth(), determineLineBreaks(), _down(), Dv() (+59 more)

### Community 120 - "SKILL.md"
Cohesion: 0.56
Nodes (4): iso(), load_module(), MorningBriefFieldDossierTests, sample_manifest()
...
Cohesion: 0.06
Nodes (40): id(), Ad(), ag(), at(), Cd(), convert(), _convertFromCellCoord(), _convertToCellCoord() (+32 more)
...
Cohesion: 0.15
Nodes (30): artifactManifestHeaderValue(), canonicalJson(), compareVersions(), ContractError, FEEDBACK_REASONS, hasOnlyKeys(), invalidCatalogRequest(), invalidModelRelease() (+22 more)
...
Cohesion: 0.09
Nodes (12): record(), FeedbackClient, FeedbackPool, withoutArtifactBytes(), catalogRequest(), release(), CLIENT_FINGERPRINT, makeServer() (+4 more)

### Community 138 - "0006_raid_model_lifecycle.sql"
Cohesion: 0.10
...
### Community 141 - "raid-model-training-job-postgres.test.mjs"
Cohesion: 0.11
Nodes (8): IngestError, check(), EventPool, examples, FIXED_NOW, HEX, ScriptedClient, TrainingPool
...
### Community 145 - "index.js"
Cohesion: 0.17
Nodes (13): verifyOperatorRequest(), ASSET_MANIFEST, createOperatorAssetHandler(), deny(), fs, handler, noStoreHeaders(), path (+5 more)

### Community 146 - "Architecture decisions"
Cohesion: 0.19
...
Cohesion: 0.07
Nodes (48): bl(), Ca(), _computeTileBoundingVolume(), createFramebuffer(), createRenderbuffer(), Cs(), depthAtPoint(), ec() (+40 more)

### Community 150 - "Recommended delivery sequence"
Cohesion: 0.04
Nodes (70): addImages(), addLineDashDependencies(), af(), backfillBorder(), bc, calculateGlyphDependencies(), cn, completeTask() (+62 more)

### Community 152 - "User Scenarios & Testing *(mandatory)*"
Cohesion: 0.33
Nodes (5): Architecture decisions, Core decision, Non-goals, Product architecture, Target data flow

### Community 153 - "Best-Effort Authenticated Observation Progress"
Cohesion: 0.15
...
### Community 157 - "ud"
Cohesion: 0.06
Nodes (114): ad(), al(), bd(), bind(), _bindFramebuffer(), Bs(), Bu(), _buildSkirts() (+106 more)

### Community 158 - "Recommended delivery sequence"
Cohesion: 0.06
Nodes (57): aa(), ao(), ba(), ca(), _calculate(), canonicalID(), crossFadingFactor(), da() (+49 more)
...
Cohesion: 0.06
Nodes (53): anyTilesAfterTime(), cameraPosition(), ji(), maybeDrawDepth(), querySourceFeatures(), an(), gn(), hn() (+45 more)
...
### Community 174 - "clear"
Cohesion: 0.17
Nodes (10): modelStore, pool, port, raidReleaseTrust, raidTrustedPublicKeysJson, server, store, createRaIDReleaseTrustVerifier() (+2 more)
...
### Community 177 - "RaID Model Lifecycle Control Plane"
Cohesion: 0.15
Nodes (12): Edge cases, Functional requirements, Key entities, Non-goals, RaID Model Lifecycle Control Plane, Scope, Success criteria, US1 — Discover an approved field model (P1) (+4 more)
...
Cohesion: 0.05
Nodes (61): ai(), allowVariableZoom(), allowWorldCopies(), calculateCameraOptionsFromTo(), calculateCenterFromCameraLngLatAlt(), _calculateNearFarZIfNeeded(), coordinatePoint(), _distanceToCenterFromAltElevationPitch() (+53 more)
...
Cohesion: 0.83
Nodes (3): main(), metadata(), parse_args()
...
Cohesion: 0.06
Nodes (104): $a(), ac(), acquireRTT(), ao(), bindRTT(), cameraForBoxAndBearing(), co(), constrainInternal() (+96 more)
...
### Community 264 - "tasks.md"
Cohesion: 0.22
Nodes (8): BSS Cybermap API — authenticated observation ingest, Deployment boundary, Device enrollment record, Implemented, Request contract, Response semantics, Run locally against PostgreSQL/PostGIS, Run tests

### Community 265 - "tests.md"
Cohesion: 0.25
Nodes (7): Edge Cases, Feature Specification: Wardriver mTLS Proxy Secret Delivery, Functional Requirements, Incident, Success Criteria, US1 — Upload through the existing trusted Wardriver enrollment (P1), User Scenario & Acceptance
...
### Community 272 - "placeCollisionCircles"
Cohesion: 0.36
...
Cohesion: 0.25
Nodes (4): NASA_EONET_EVENTS_ADAPTER, USGS_EARTHQUAKES_ADAPTER, ADAPTERS, FIXTURE_DIRECTORY
...
### Community 278 - "loadVisionEndpoint"
Cohesion: 0.60
...
### Community 286 - "Sensorium Roadmap"
Cohesion: 0.33
...
### Community 287 - "Wardriver mTLS Direct API"
Cohesion: 0.33
Nodes (5): Acceptance, Definitions, Functional requirements, Purpose, Wardriver mTLS Direct API

### Community 288 - "0005_device_scoped_observation_identity.sql"
Cohesion: 0.33
Nodes (5): hardeningMigration, installer, migration, modelStore, root

### Community 290 - "Cybermap database migrations"
Cohesion: 0.40
Nodes (5): Loop runs, Memory sync, Narrative, Paper loop, VM API contract extensions

### Community 291 - "Current Limitations"
Cohesion: 0.40
Nodes (4): Affected files, Constitution check, Plan, Verification strategy
...
Cohesion: 0.07
Nodes (32): deriveWardriverProgress(), aggregateCaveats(), aggregateFreshness(), aggregateLayers(), aggregateSourceClasses(), boundedGlobalLimit(), finiteInteger(), finiteOrNull() (+24 more)
...
### Community 312 - "Integration Points"
Cohesion: 0.28
Nodes (6): headers(), NOW, packageHash(), stableJson(), validPackage(), withServer()

### Community 318 - "User Scenarios & Testing *(mandatory)*"
Cohesion: 0.14
...
### Community 320 - "Feature Specification: Wardriver mTLS Proxy Secret Delivery"
Cohesion: 0.33
Nodes (5): Affected Files, Approach, Implementation Plan: Wardriver mTLS Proxy Secret Delivery, Root Cause, Security Boundary

### Community 326 - "Implementation Plan: Adversarial Review Repairs"
Cohesion: 0.29
...
### Community 328 - "Tasks: Adversarial Review Repairs"
Cohesion: 0.33
...
### Community 329 - "Test Design: Adversarial Review Repairs"
Cohesion: 0.33
Nodes (5): Commands, Fixture authority, Required negative cases, Test Design: Adversarial Review Repairs, Traceability

## Knowledge Gaps
- **1554 isolated node(s):** `check-prerequisites.sh script`, `common.sh script`, `create-new-feature.sh script`, `setup-plan.sh script`, `setup-tasks.sh script` (+1549 more)
...
- **Why does `error()` connect `postgres-store.mjs` to `index.js`, `postgres-store.test.mjs`, `hashCanonicalJson`, `index.js`, `greenfeed-worker.mjs`, `Implementation Plan: Static Web Application Functionality`, `index.js`, `main.js`, `server.mjs`, `$`, `main.js`, `loadVisionEndpoint`, `Recommended delivery sequence`, `adapter-contract.mjs`, `morning-brief.test.mjs`, `validatePaperState`?**
  _High betweenness centrality (0.090) - this node is a cross-community bridge._
- **Why does `key()` connect `tzeentch.mjs` to `index.js`, `tzeentch-dashboard.mjs`, `BSS Cybermap API — authenticated observation ingest`, `wigle.mjs`, `createIndexBuffer`, `$`, `vision.mjs`, `_executeRelevantHandler`, `server.mjs`, `postgres-store.test.mjs`, `operator-auth.js`, `hashCanonicalJson`, `contracts.mjs`, `Integration Points`, `validatePaperState`, `deflock-viewport-contract.mjs`, `raid-model-store.mjs`, `Wu`, `index.js`, `cybermap-global-viewport-api.test.mjs`, `cybermap-viewport-api.test.mjs`?**
  _High betweenness centrality (0.066) - this node is a cross-community bridge._
- **Why does `createRequestHandler()` connect `server.mjs` to `wardriver-release-store.js`, `postgres-store.mjs`, `Recommended delivery sequence`, `deflock-viewport-contract.mjs`, `morning-brief.test.mjs`, `add`?**
